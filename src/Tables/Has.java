    ...
    public static void createTable(Connection connection) {
        try (Statement statement = connection.createStatement()) {
            String sql = "CREATE TABLE IF NOT EXISTS Has (" +
                    ...
                    "FOREIGN KEY (AID) REFERENCES Amenities(AID))"; // "Listing" and "Amenities" should be replaced with the actual table names of the Listing and Amenities tables, respectively
